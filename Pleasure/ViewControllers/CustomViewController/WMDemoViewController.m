...
//    [WMLoginManager executeOperationHasLogin:^{
//        UIAlertView *av = [[UIAlertView alloc] initWithTitle:@"提示" message:@"收藏成功" delegate:self cancelButtonTitle:@"知道了" otherButtonTitles: nil];
//        [av show];
//    }];
    
    [WMLoginManager executeDirectlyOperationAfterLogin:^{
        UIAlertView *av = [[UIAlertView alloc] initWithTitle:@"提示" message:@"收藏成功" delegate:self cancelButtonTitle:@"知道了" otherButtonTitles: nil];
        [av show];
    }];
