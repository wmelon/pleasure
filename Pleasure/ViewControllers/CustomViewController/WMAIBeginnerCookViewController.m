...
@interface WMAIPopAnimator : NSObject<UIViewControllerAnimatedTransitioning>
/** 持续时间*/
...
@implementation WMAIPopAnimator
...
/** 转场动画*/
@property(nonatomic,strong)WMAIPopAnimator *transition;
@end
...
- (WMAIPopAnimator *)transition {
    if (!_transition) {
        _transition = [[WMAIPopAnimator alloc]init];
    }
    return _transition;
}
