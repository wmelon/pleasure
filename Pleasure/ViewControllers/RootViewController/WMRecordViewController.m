...
@interface WMRecordViewController ()<WMInputInfoViewDataSource , WMInputInfoViewDelegate>
...
- (WMInputInfoView *)inputInfoView{
    ...
    if (_inputInfoView == nil){
        ...
        _inputInfoView.dataSource = self;
